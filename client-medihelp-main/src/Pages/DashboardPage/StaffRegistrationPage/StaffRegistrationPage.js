...
export default function StaffRegistrationPage() {
    ...
    return (
        <section className="staffRegistrationPage" >
            <div className="row">
                <div className='col-lg-2 col-md-3'><Sidebar /></div>
                <div className="col-lg-10 col-md-9 p-4 staffRegistrationPageContainer" >
                    <h3 className='text-center p-3'>Staff Registration</h3>
                        ...
                        <div className="col-lg-8 col-sm-10 contact-form p-4">
                            <form onSubmit={handleSubmit(onSubmit)}>
                                <div className="form-group">
                                    ...
                                    <label for="patientName" className="w-100"><h6>Staff Name: </h6>
                                    ...
                                    <label for="patientEmail" className="w-100"><h6>Email: </h6>
                                    ...
                                    <label for="patientPassword" className="w-100"><h6>Password: <small>(6-16 chars)</small></h6>
                                        ...
                                        {errors.patientEmail && <span className="text-danger">This field is required</span>}
                                        <label for="showPassword" className='pb-3'>
                                        <input type="checkbox" onClick={handleShowPassword} /> {(showPassword) ? 'hide password' : 'show password'}
                                    </label>
                                    </label>
                                    ...
                                    <label for="patientAddress" className="w-100"><h6>Address: </h6>
                                        <input type="text" id="patientAddress" maxLength="20"  {...register('patientAddress')} name="patientAddress" placeholder="" className="form-control m-2" required />
                                        {errors.patientAge && <span className="text-danger">This field is required</span>}
                                    </label>
